...
interface EmpresaModalErrorProps {
  error: Error & { digest?: string }
  reset: () => void
}

export default function EmpresaModalError({ error, reset }: EmpresaModalErrorProps) {
          ...
          <div className="flex items-center justify-center py-8">
            <div className="text-center space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Você pode tentar novamente ou voltar à lista de clientes.
              </p>
            </div>
          </div>
