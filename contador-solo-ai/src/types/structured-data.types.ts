...
// =====================================================
// TIPOS PARA MÉTRICAS E ANÁLISES
// =====================================================
...
export interface ComplianceAnomaly {
  id: string;
  tipo: 'prazo_vencido' | 'valor_inconsistente' | 'documento_faltante' | 'calculo_incorreto';
  severidade: 'baixa' | 'media' | 'alta' | 'critica';
  descricao: string;
  data_deteccao: Date;
  empresa_id: string;
  detalhes: Record<string, unknown>;
  status: 'detectada' | 'em_analise' | 'resolvida' | 'falso_positivo';
}
...
export interface PersonalizedExperience {
  ...
  preferencias: {
    ...
    widgets_favoritos: string[];
    notificacoes_ativas: string[];
    tema_personalizado: Record<string, unknown>;
  };
  insights_personalizados: string[];
  atalhos_rapidos: Array<{
    nome: string;
    acao: string;
